...
export const CtaBanner: React.FC<CtaBannerProps> = ({
  ...
  return (
    <div
      ...
      className={`w-full max-w-[1408px] mx-auto bg-[#020609] rounded-[30px] py-12 sm:py-16 lg:py-0 lg:h-[235px] px-6 sm:px-12 lg:px-16 flex items-center justify-between flex-col lg:flex-row gap-8 lg:gap-12 select-none ${className}`}
    >
      {/* Headline EGR1P */}
      <h2
        data-name="Ready to work with us ?"
        className="text-white text-[36px] sm:text-[52px] lg:text-[72px] xl:text-[80px] font-semibold leading-[1.2] lg:leading-[1.3] tracking-[-1.5px] lg:tracking-[-2.4px] font-sans text-center lg:text-left"
      >
      ...
      <button
        ...
        className="h-[56px] px-8 rounded-[70px] bg-white flex items-center justify-center gap-6 sm:gap-10 shrink-0 text-[#010205] select-none"
      >
