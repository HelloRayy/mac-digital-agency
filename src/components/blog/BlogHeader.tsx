    ...
    >
      ...
      >
        ...
        <button
          type="button"
          onClick={onSeeMore}
          className="w-[156px] h-[52px] rounded-[50px] border border-[#010205] flex items-center justify-center text-[#010205] font-sans font-bold text-[16px] tracking-[-0.32px] transition-colors hover:bg-black/5 active:scale-95 cursor-pointer select-none"
        >
          See more
        </button>
      </div>
